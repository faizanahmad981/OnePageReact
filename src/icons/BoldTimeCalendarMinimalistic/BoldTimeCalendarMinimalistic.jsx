...
export const BoldTimeCalendarMinimalistic = ({ color = "#C5CBD5", className }) => {
  return (
    <svg
      className={`bold-time-calendar-minimalistic ${className}`}
      fill="none"
      height="24"
      viewBox="0 0 24 24"
      width="24"
...
BoldTimeCalendarMinimalistic.propTypes = {
